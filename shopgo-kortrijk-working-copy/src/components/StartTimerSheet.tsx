...
import { BellRing, Loader2, Play, X } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      >
        ...
        {selected > 0 && (
          <div className="mt-4 flex items-start gap-2.5 rounded-2xl bg-primary/8 p-3 text-[12px] leading-relaxed text-muted-foreground ring-1 ring-primary/15">
            <BellRing className="mt-0.5 h-4 w-4 shrink-0 text-primary" />
            <span>
              Na het starten vraagt je telefoon toestemming voor meldingen. Kies <strong className="text-foreground">Toestaan</strong> om je alarm te ontvangen.
            </span>
          </div>
        )}
